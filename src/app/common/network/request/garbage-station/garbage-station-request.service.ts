...
export class GarbageStationRequestService extends AbstractService<GarbageStation> {
  ...
  private _sensor?: GarbageStationSensorRequestService;
  public get sensor(): GarbageStationSensorRequestService {
    if (!this._sensor) {
      this._sensor = new GarbageStationSensorRequestService(this.basic);
    }
    return this._sensor;
  }
}
