...
import { SensorEventData } from './garbage-station/event-record/sensor/sensor-event-record.model';
import { SewageEventData } from './garbage-station/event-record/sewage-event-record.model';
import { SmokeEventData } from './garbage-station/event-record/smoke/smoke-event-record.model';
...
export function transformEventRecordData(params: TransformFnParams) {
  ...
  switch (record.EventType) {
    ...
    case EventType.Smoke:
      return plainToInstance(SmokeEventData, params.value);
    case EventType.SensorOffline:
    case EventType.SensorValue:
      return plainToInstance(SensorEventData, params.value);
    default:
