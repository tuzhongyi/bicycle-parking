...
@Component({
  selector: 'howell-bicycle-parking-video-window',
  imports: [
    CommonModule,
  ...
  templateUrl: './bicycle-parking-video-window.component.html',
  styleUrl: './bicycle-parking-video-window.component.less',
})
export class BicycleParkingVideoWindowComponent
  extends BicycleParkingWindowComponent
